...
const routes$1 = Object.fromEntries([
  ["/", { loader: () => import(
    ...
    "./assets/index.html-CbEhEr0G.js"
  ), meta: { "title": "主页" } }],
  ["/components/ak-button-group.html", { loader: () => import(
    /* webpackChunkName: "components_ak-button-group.html" */
    "./assets/ak-button-group.html-DhjM5lsw.js"
  ), meta: { "title": "ak-button-group 按钮组" } }],
  ["/components/ak-button.html", { loader: () => import(
    /* webpackChunkName: "components_ak-button.html" */
    "./assets/ak-button.html-Ba9WOfoS.js"
  ), meta: { "title": "ak-button 按钮" } }],
  ["/components/ak-card.html", { loader: () => import(
    /* webpackChunkName: "components_ak-card.html" */
    "./assets/ak-card.html-B73PLfcq.js"
  ), meta: { "title": "ak-card 卡片" } }],
  ["/components/ak-counter.html", { loader: () => import(
    /* webpackChunkName: "components_ak-counter.html" */
    "./assets/ak-counter.html-De6erDw3.js"
  ), meta: { "title": "ak-counter 计数器" } }],
  ["/components/ak-divider.html", { loader: () => import(
    /* webpackChunkName: "components_ak-divider.html" */
    "./assets/ak-divider.html-D4bMCLsi.js"
  ), meta: { "title": "ak-divider 分割线" } }],
  ["/components/ak-form.html", { loader: () => import(
    /* webpackChunkName: "components_ak-form.html" */
    "./assets/ak-form.html-CaOhBa0c.js"
  ), meta: { "title": "ak-form 表单" } }],
  ["/components/ak-fx.html", { loader: () => import(
    /* webpackChunkName: "components_ak-fx.html" */
    "./assets/ak-fx.html-DG7s7Ekv.js"
  ), meta: { "title": "ak-fx 效果" } }],
  ["/components/ak-helper.html", { loader: () => import(
    /* webpackChunkName: "components_ak-helper.html" */
    "./assets/ak-helper.html-wiRvsWEl.js"
  ), meta: { "title": "ak-helper" } }],
  ["/components/ak-icon.html", { loader: () => import(
    /* webpackChunkName: "components_ak-icon.html" */
    "./assets/ak-icon.html-C0qUjqpC.js"
  ), meta: { "title": "ak-icon 图标" } }],
  ["/components/ak-level.html", { loader: () => import(
    /* webpackChunkName: "components_ak-level.html" */
    "./assets/ak-level.html-DflapXUk.js"
  ), meta: { "title": "ak-level 关卡" } }],
  ["/components/ak-loading.html", { loader: () => import(
    /* webpackChunkName: "components_ak-loading.html" */
    "./assets/ak-loading.html-CZw1Bfme.js"
  ), meta: { "title": "ak-loading 加载" } }],
  ["/components/ak-media.html", { loader: () => import(
    /* webpackChunkName: "components_ak-media.html" */
    "./assets/ak-media.html-C7txpuCl.js"
  ), meta: { "title": "ak-media 媒体" } }],
  ["/components/ak-object.html", { loader: () => import(
    /* webpackChunkName: "components_ak-object.html" */
    "./assets/ak-object.html-C2yqKfEB.js"
  ), meta: { "title": "ak-object 物体" } }],
  ["/components/ak-pagination.html", { loader: () => import(
    /* webpackChunkName: "components_ak-pagination.html" */
    "./assets/ak-pagination.html-DADvyFVa.js"
  ), meta: { "title": "ak-pagination 分页" } }],
  ["/components/ak-panel.html", { loader: () => import(
    /* webpackChunkName: "components_ak-panel.html" */
    "./assets/ak-panel.html-D-ZZM0Ru.js"
  ), meta: { "title": "ak-panel 面板" } }],
  ["/components/ak-san.html", { loader: () => import(
    /* webpackChunkName: "components_ak-san.html" */
    "./assets/ak-san.html-BCb7gThK.js"
  ), meta: { "title": "ak-san 理智" } }],
  ["/components/", { loader: () => import(
    /* webpackChunkName: "components_index.html" */
    "./assets/index.html-ireyL3DH.js"
  ), meta: { "title": "设计规范" } }],
  ["/guide/", { loader: () => import(
    /* webpackChunkName: "guide_index.html" */
    "./assets/index.html-ZUOT1TL-.js"
  ), meta: { "title": "使用指南" } }],
  ["/guide/style.html", { loader: () => import(
    /* webpackChunkName: "guide_style.html" */
    "./assets/style.html-CmgVrDyJ.js"
  ), meta: { "title": "风格指南" } }],
  ["/404.html", { loader: () => import(
    /* webpackChunkName: "404.html" */
    "./assets/404.html-B6_VfuFs.js"
  ), meta: { "title": "" } }]
]);
...
var define_GIT_OPTIONS_default = { provider: null, pattern: {}, repo: "https://github.com/YunYouJun/ak-ui" };
...
const themeData$1 = JSON.parse(`{"logo":"/ak.svg","navbar":[{"text":"Home","link":"/"},{"text":"Guide","link":"/guide/"},{"text":"Components","link":"/components/"}],"sidebar":{"/guide/":["","style"],"/components/":["","ak-button","ak-button-group","ak-card","ak-counter","ak-divider","ak-fx","ak-form","ak-icon","ak-level","ak-loading","ak-media","ak-object","ak-panel","ak-pagination","ak-san"]},"lastUpdated":"上次更新","repo":"https://github.com/YunYouJun/ak-ui","docsDir":"docs","editLinks":true,"editLinkText":"帮助改善此页面！( ￣□￣)/","locales":{"/":{"selectLanguageName":"English"}},"colorMode":"auto","colorModeSwitch":true,"selectLanguageText":"Languages","selectLanguageAriaLabel":"Select language","sidebarDepth":2,"editLink":true,"contributors":true,"contributorsText":"Contributors","notFound":["There's nothing here.","How did we get here?","That's a Four-Oh-Four.","Looks like we've got some broken links."],"backToHome":"Take me home","openInNewWindow":"open in new window","toggleColorMode":"toggle color mode","toggleSidebar":"toggle sidebar"}`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        "vp-container": ""
      }, _attrs))} data-v-ec9917b8><main class="page" data-v-ec9917b8><div vp-content data-v-ec9917b8><h1 data-v-ec9917b8>404</h1><blockquote data-v-ec9917b8>${ssrInterpolate(getMsg())}</blockquote>`);
...
const NotFound = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ec9917b8"]]);
...
const siteData$1 = JSON.parse('{"base":"/","lang":"zh-CN","title":"ak-ui","description":"Arknights UI Framework","head":[["link",{"rel":"icon","href":"/ak.png"}],["script",{"async":true,"src":"//at.alicdn.com/t/font_1623879_1wzsjomrpmm.js"}],["link",{"rel":"stylesheet","href":"https://fonts.googleapis.com/css?family=Noto+Sans+SC:400,500,700,900|Noto+Serif+SC:400,500,700,900|Syncopate:700&display=swap"}]],"locales":{}}');
